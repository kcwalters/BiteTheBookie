...
{
    /// <summary>
    /// Backing model for the ESPN-style NHL landing page: today's schedule plus the
    /// latest NHL headlines, all sourced from live ESPN feeds.
    /// </summary>
    public class NHLLandingViewModel
    {
        ...
        public string LeagueLogo => "https://a.espncdn.com/i/teamlogos/leagues/500/nhl.png";
