...
namespace BiteTheBookie.Controllers
{
    public class NHLController : Controller
    {
        ...
        public NHLController(INHLScoresService scoresService, INewsService newsService, ILeagueScheduleService scheduleService, BiteTheBookie.Services.Implementations.EspnApiClient espnApiClient)
        {
        ...
        public async Task<IActionResult> Team(string code)
        {
            ...
            viewModel.Schedule = await _espnApiClient.GetTeamScheduleAsync("hockey/nhl", EspnCode(code));
